---
description: Mark current branch's active plan done, flip its spec, regenerate the index.
---
...
3. Review the staged diff. `board.py finish` stages the plan/spec/index updates.
